...
namespace Monsajem_Incs.Serialization.New_NotForUse
{
    ...
    public partial class Serialization
    {
        ...
        [ThreadStaticAttribute]
        private static Array<ObjectContainer> Visitor;
        [ThreadStaticAttribute]
        private static Array<ObjectContainer> Visitor_info;
        ...
        private byte[] _Serialize<t>(t obj)
        {
            lock (this)
            {
                ...
                if (Serialization.S_Data == null)
                {
                    ...
                    Serialization.Visitor = new Array<ObjectContainer>(20);
                    Serialization.Visitor_info = new Array<ObjectContainer>(20);
                }
