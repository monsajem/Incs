...
namespace Monsajem_Incs.HttpService
{
        ...
        Responsor
    {
            ...
            base(Way, Service)
        {
            ...
            {
                var Action = System.Convert.FromBase64String(Request.Data.ToString()).Deserialize<Delegate>();
            ...
            () =>
            {
                ...
                var Action =Convert.FromBase64String(ResponsorData).Deserialize<Delegate>();
            ...
            () =>
            {
                ...
                var Action = Convert.FromBase64String(
                                Request.MyContext.Request.QueryString.Get("Action")).Deserialize<Delegate>();
    ...
    public class Responsor
    {
            ...
            Action Service)
        {
            ...
            BinaryInsert(ref Childs, Response);
    ...
    public class StopedTreadeException : Exception { }

    public static class TreadeExtentions
    {
        public static void StopThreade()
        {
            throw new StopedTreadeException();
        }
    }
}
