...
namespace WebAssembly.Browser.DOM
{
    ...
    [Export("HTMLTableElement", typeof(IJSInProcessObjectReference))]
    public sealed class HTMLTableElement : HTMLElement, IHTMLTableElement
    {
        internal HTMLTableElement(IJSInProcessObjectReference handle) : base(handle) { }
        ...
        {
            _ = InvokeMethod<object>("deleteCaption");
        }
        [Export("deleteRow")]
        public void DeleteRow(double index)
        {
            _ = InvokeMethod<object>("deleteRow", index);
        }
        [Export("deleteTFoot")]
        public void DeleteTFoot()
        {
            _ = InvokeMethod<object>("deleteTFoot");
        }
        [Export("deleteTHead")]
        public void DeleteTHead()
        {
            _ = InvokeMethod<object>("deleteTHead");
        }
        [Export("insertRow")]
