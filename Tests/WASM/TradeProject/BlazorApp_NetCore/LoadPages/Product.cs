                            ...
                            Calculate_wall.Calculator.UniverseSummary Info)
                        {
                            ...
                            string InfoName)
                            {
                                    ...
                                    string InfoName)
                                {
                                    AppendData(Holder, InfoName);
                                    var Describe = "";
                                    Describe += " RSI_14:" + Info.Rate_RSI_14;
                                    Describe += " RSI_100:" + Info.Rate_RSI_100;
                                    Describe += " MFI_14:" + Info.Rate_MFI_14;
                                    Describe += " MFI_100:" + Info.Rate_MFI_100;
                                    Describe += " DEMA:" + Info.Rate_DEMA_Cross;
                                    Describe += " CRSI:" + Info.Rate_CRSI;
