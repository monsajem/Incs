...
namespace System.Net.Http
{
	...
	public class WebAssemblyHttpHandler : HttpMessageHandler {
		...
		{
			window = (JSObject)Runtime.InteropServices.JavaScript.Runtime.GetGlobalObject ("window");
			fetch = (JSObject)Runtime.InteropServices.JavaScript.Runtime.GetGlobalObject ("fetch");
		}
